                ...
                <div className="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
                    ...
                    <div className="flex md:order-2 space-x-3 md:space-x-0 rtl:space-x-reverse">
                        ...
                        {isProductsPage && (
                            ...
                            <a href='/login'><button type="button" className="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-4 py-2 text-center dark:bg-blue-600 dark:hover:bg-red-700 ">Log In DashBoard
                            </button></a>
                        )}
                        {isDashboardPage && (
                            ...
                            <li>
                                <form className="max-w-md" onSubmit={handleSubmit}>
                                    ...
                                    <div className="relative border w-full">
                                        ...
                                        <input type="search" id="searchQuery" ref={inputRef} className="block w-full p-4 ps-10 text-sm lg:w-96 dark:bg-gray-700 dark:border-gra-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-00" placeholder="Search" required />
